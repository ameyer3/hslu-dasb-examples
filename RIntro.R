...
#logical operators == != > < 
#case 
X_1 <- c(1:10) # TODO 0 or 1 based? Including forst or second
X_1 == x_1
X_1 <- 3
X_1 <- "EEE"
...
T1A <- c(10,20,30) + 1:5 # TODO is this 1,2,3,4,5 or something else?

#Accessing elements of a vector can be done via indexing, using square brackets.
T1A[c(2,4,5)] # (can also be T1A[2,4,5]) # TODO is this new now?
t1b[2:3] == t1b[-1:-2]
